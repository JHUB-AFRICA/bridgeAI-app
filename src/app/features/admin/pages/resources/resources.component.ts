        ...
        <table class="data-table">
          ...
          <tbody>
            <tr *ngFor="let resource of resources()">
              ...
              <td><span class="wp-tag" [style.background]="getWpColor(resource.wp_tag)">{{ resource.wp_tag }}</span></td>
              <td>{{ resource.resource_type }}</td>
              <td>{{ resource.language }}</td>
              <td>
                <span class="status-badge" [class.public]="resource.is_public">
                  {{ resource.is_public ? 'Yes' : 'No' }}
                </span>
              </td>
              <td class="actions-cell">
                ...
                <button class="btn-icon delete" (click)="deleteResource(resource.id)" title="Delete">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16">
            ...
            <form (ngSubmit)="saveResource()" #resourceForm="ngForm">
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <select [(ngModel)]="formData.language" name="language" required class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="url" [(ngModel)]="formData.external_url" name="external_url" class="form-control" placeholder="https://..." />
              </div>
